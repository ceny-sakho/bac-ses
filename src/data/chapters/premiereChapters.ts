...
export const premiereChapters: Record<string, ChapterData> = {
  "premiere-ch1": {
  ...
  "premiere-ch2": {
    ...
    objectives: [
      ...
      "Comprendre que le monopole est faiseur de prix et être capable de donner des exemples de monopole (monopole naturel, institutionnel et d'innovation)",
  ...
  "premiere-ch7": {
    ...
    image: "/lovable-uploads/cedefef7-cfe5-43e3-b3d4-39497e91d0a7.png"
  },
  "premiere-ch8": {
