...
export const NotionsViewer: React.FC<NotionsViewerProps> = ({
  ...
  useEffect(() => {
    ...
    const pdfPath = `/${levelFolder}/${subjectFolder}/chapitre${chapterNumber}/notions/notions${chapterNumber}.pdf`;
  ...
  const handleDownload = () => {
    ...
    link.href = url;
    const chapterNumber = getChapterNumber();
    link.download = `notions-${getLevelFolder()}-${getSubjectFolder()}-chapitre${chapterNumber}.pdf`;
    ...
    toast({
      ...
      description: "Les notions sont en cours de téléchargement",
    });
  };
